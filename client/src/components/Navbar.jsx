...
export const Frame = () => {
  return (
    <div className="flex flex-col w-[1440px] items-start gap-2.5 px-[60px] py-6 relative bg-white">
      <div className="flex items-center gap-8 relative self-stretch w-full flex-[0_0_auto]">
        <img className="relative w-[101px] h-14 object-cover" alt="Image" src="image-1.png" />
        <div className="inline-flex items-center gap-3 relative flex-[0_0_auto]">
          <div className="relative w-5 h-5">
            <img className="absolute w-4 h-4 top-0.5 left-0.5" alt="Union" src="union.svg" />
          </div>
        ...
        <div className="flex items-center gap-9 relative flex-1 grow">
          ...
          <img className="relative flex-[0_0_auto]" alt="Frame" src="frame-1000004971.svg" />
          <div className="inline-flex h-10 items-center gap-3 relative flex-[0_0_auto]">
            <img className="relative w-10 h-10" alt="Ellipse" src="ellipse-331.svg" />
